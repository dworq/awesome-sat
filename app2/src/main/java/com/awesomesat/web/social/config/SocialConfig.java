 ...
 */
package com.awesomesat.web.social.config;
...
import com.awesomesat.app.domain.user.SecurityContext;
import com.awesomesat.app.domain.user.SimpleConnectionSignUp;
import com.awesomesat.app.domain.user.SimpleSignInAdapter;
import com.awesomesat.app.domain.user.User;
